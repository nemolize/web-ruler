...
test.describe('Index Page', () => {
  test('should load the home page', async ({ page }) => {
    ...
    // Check main heading
    await expect(page.getByRole('heading', { name: 'Welcome to Next.js with Mantine!', level: 1 })).toBeVisible();
    
    // Check welcome text
    await expect(page.getByText('Mantine has been successfully set up in your Next.js project.')).toBeVisible();
  });
  ...
  test('should have correct meta description', async ({ page }) => {
    ...
    await expect(metaDescription).toHaveAttribute('content', 'Next.js app with Mantine UI');
  });
